...
# print("original", len(first_pts))
# first_pts = np.unique(first_pts)
# print("unique", len(first_pts))

comp_points(first_pts, second_pts, dis = 10)
