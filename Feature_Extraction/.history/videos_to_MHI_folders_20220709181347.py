...
while True:
    ...
    if not os.path.exists("../MHI_20_datas/testData1"):
        os.makedirs("../MHI_20_datas/testData1")
    if not os.path.exists("../MHI_20_datas/testData1/Cam1"):
        os.makedirs("../MHI_20_datas/testData1/Cam1")
    currentFrame += 1
    if os.path.isfile("../MHI_20_datas/testData1/Cam1/frame%d.jpg" % currentFrame):
        os.remove("../MHI_20_datas/testData1/Cam1/frame%d.jpg" % currentFrame)
    cv2.imwrite("../MHI_20_datas/testData1/Cam1/frame%d.jpg" % currentFrame, mh)
