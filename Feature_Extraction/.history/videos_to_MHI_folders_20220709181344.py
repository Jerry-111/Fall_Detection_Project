...
while True:
    ...
    currentFrame += 1
    if os.path.isfile("../MHI_datas/testData1/Cam1/frame%d.jpg" % currentFrame):
        os.remove("../MHI_datas/testData1/Cam1/frame%d.jpg" % currentFrame)
    cv2.imwrite("../MHI_datas/testData1/Cam1/frame%d.jpg" % currentFrame, mh)
